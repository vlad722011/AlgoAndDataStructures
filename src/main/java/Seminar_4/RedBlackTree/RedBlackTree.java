...
// Класс реализующий красно-черное дерево на основе интерфейса IRedBlackTree.
public class RedBlackTree<T extends Comparable<T>> implements IRedBlackTree<T>, Iterable<T>, Iterator<T> {
    ...
    public class Node {
        ...
        // value - значение, которое будет сохранено в узле. color - цвет узла.
        ...
        // Конструктор копий. node - другой узел.
        ...
        // проверка узла на черный цвет. возвращает true, если цвет узла черный и false если узел красный.
        public boolean isBlack() {
            return _color == NodeColor.BLACK;
        }

        // окрашиваем узел в черный цвет.
        public void makeBlack() {
            _color = NodeColor.BLACK;
        }

        // проверка узла на красный цвет. возвращает true, если цвет узла красный и false если узел черный.
        public boolean isRed() {
            return _color == NodeColor.RED;
        }

        // окрашиваем узел в красный цвет.
        public void makeRed() {
            _color = NodeColor.RED;
        }

        // Метод, возвращающий "дедушку" узла дерева.
        ...
        // Метод, возвращающий "дядю" узла дерева.
        ...
        // Метод, возвращающий следующий по значению узел дерева.
    ...
    /*
      ...
      корректно работали методы итератора hasNext(), и next().
     */
    ...
    /*
      ...
      параметры метода: tree - дерево, node - узел, относительно которого осуществляется левый поворот.
     */
    ...
    /*
      ...
      параметры метода: tree - дерево, node - узел, относительно которого осуществляется правый поворот.
     */
    ...
    /*
      ...
      создается узел дерева типа Node красного цвета.
      параметр "o" - значение типа Comparable для вставки в дерево.
     */
    @Override
    public void add(T o) {
    ...
    // Исправление дерева для сохранения свойств красно-черного дерева.
